...
namespace CucuTools
{
    public struct CucuMath
    {
        ...
        public static void SearchRange<T>(out int left, out int right, T value, params T[] values)
            where T : IComparable
        {
            left = -1;
            right = -1;
        ...
        public static void SearchRange<T>(out int left, out int right, T value, List<T> values)
            where T : IComparable
        {
            left = -1;
            right = -1;
        ...
        public static void SearchRange(out int left, out int right, float value, params float[] values)
        {
            SearchRange<float>(out left, out right, value, values);
        }

        public static void SearchRange(out int left, out int right, int value, params int[] values)
        {
            SearchRange<int>(out left, out right, value, values);
        }
        
        public static void SearchRange<T>(out int left, out int right, T value, IEnumerable<T> values)
            where T : IComparable
        {
            SearchRange<T>(out left, out right, value, values.ToArray());
        }
